										...
										<div class="message-box">
											...
											<div class="peoples-mesg-box">
                                                                                            <%
                                                                                                ...
                                                                                                String q3="SELECT * FROM user WHERE email='"+val+"'";
                                                                                                ResultSet rt=userDao.Retrieve(q3);
                                                                                                if(rt.next()){
                                                                                                    pic4=rt.getBlob("image");
                                                                                                    img4=adminDao.imageConversion(pic4);
                                                                                            %>
												<div class="conversation-head">
													<figure><img src='data:image/jpeg;base64, <%=img4%>'></figure>
													<span><%=rt.getString("name")%> <i>online</i></span>
												</div>
												<ul class="chatting-area">
                                                                                                <%
                                                                                                    String img5="";
                                                                                                    Blob pic5=null;
                                                                                                    String q4="SELECT * FROM chat WHERE (msgfrom='"+email+"' && msgto='"+val+"') OR(msgfrom='"+val+"' && msgto='"+email+"')";
                                                                                                    ResultSet rf=userDao.Retrieve(q4);
                                                                                                    while(rf.next()){
                                                                                                        String msf=rf.getString("msgfrom");
                                                                                                        if(msf.equals(val)){
                                                                                                            String q5="SELECT * FROM user WHERE email='"+val+"'";
                                                                                                            ResultSet rh=userDao.Retrieve(q5);
                                                                                                            if(rh.next()){
                                                                                                            pic5=rh.getBlob("image");
                                                                                                            img5=adminDao.imageConversion(pic5);
                                                                                                %>
													<li class="you">
														<figure><img src='data:image/jpeg;base64, <%=img5%>'></figure>
														<p><%=rf.getString("message")%></p>
													</li>
                                                                                                <%
                                                                                                    }
                                                                                                    }else{
                                                                                                        String q5="SELECT * FROM user WHERE email='"+email+"'";
                                                                                                            ResultSet rh=userDao.Retrieve(q5);
                                                                                                            if(rh.next()){
                                                                                                            pic5=rh.getBlob("image");
                                                                                                            img5=adminDao.imageConversion(pic5);
												...
												<div class="message-text-container">
                                                                                                    <form method="post" action="messageAction.jsp">
                                                                                                        <input type="hidden" name="msgto" id="msgto" value="<%=val%>">
                                                                                                        <input type="hidden" name="msgfrom" id="msgfrom" value="<%=email%>">
