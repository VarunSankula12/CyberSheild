   ...
   <section class="section dashboard ">
        <div class="col-md-12 mb-4">
                <div class="card-header py-3">
                    <h5 class="mb-0">User Authentication</h5>
                </div>
    ...
    <td>
        <a href="acceptUser.jsp?email=<%=rs.getString("email")%>"<button class="btn btn-success">Accept</button></a>
        <a href="rejectUser.jsp?email=<%=rs.getString("email")%>"<button class="btn btn-danger">Reject</button></a>
    </td>
</tr>
<%
    }
