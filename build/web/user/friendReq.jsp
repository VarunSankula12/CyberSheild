								...
								<div class="central-meta">
									<div class="frnds">
										<ul class="nav nav-tabs">
                                                                                    <li class="nav-item"><a  href="friends.jsp">My Friends</a></li>
                                                                                    <li class="nav-item"><a class="active" href="friendReq.jsp">Friend Requests</a></li>
										</ul>
...
<%
        ...
        String img="";
        String mail="";
        String query="SELECT * FROM friendreq WHERE toemail='"+email+"' && status='Pending'";
											...
											<li>
												<div class="nearly-pepls">
													...
													<div class="pepl-info">
														...
														<span>Member</span>
                                                                                                                <a href="rejectReq.jsp?fromemail=<%=mail%>" title="" class="add-butn more-action" data-ripple="">reject Request</a>
                                                                                                                <a href="acceptReq.jsp?fromemail=<%=mail%>" title="" class="add-butn" data-ripple="">Confirm</a>
