								...
								<div class="central-meta">
									<div class="frnds">
										<ul class="nav nav-tabs">
                                                                                    <li class="nav-item"><a class="active" href="friends.jsp">My Friends</a></li>
                                                                                    <li class="nav-item"><a  href="friendReq.jsp">Friend Requests</a></li>
										</ul>
...
<%
        Blob pic=null;
        String img="";
        String query="SELECT * FROM friendreq WHERE toemail='"+email+"' && status='Accepted'";
        ResultSet rs=userDao.Retrieve(query);
        while(rs.next()){
        String mail=rs.getString("fromemail");
        String q2="SELECT * FROM user WHERE email='"+mail+"'";
        ResultSet val=userDao.Retrieve(q2);
        if(val.next()){
            pic=val.getBlob("image");
...
%>
											<li>
												<div class="nearly-pepls">
													<figure>
														<a href="#" title=""><img src='data:image/jpeg;base64, <%=img%>'></a>
													</figure>
													<div class="pepl-info">
                                                                                                            <h4><a href="#" title=""><%=val.getString("name")%></a></h4>
														<span>Member</span>
														<!--<a href="#" title="" class="add-butn more-action" data-ripple="">unfriend</a>-->
														<a href="unfriend.jsp?frndemail=<%=mail%>" title="" class="add-butn" data-ripple="">unfriend</a>
													</div>
												</div>
											</li>
<%
...
<%
        Blob pic1=null;
        String img1="";
        String query1="SELECT * FROM friendreq WHERE fromemail='"+email+"' && status='Accepted'";
        ResultSet rs3=userDao.Retrieve(query1);
        while(rs3.next()){
        String mail=rs3.getString("toemail");
        String q3="SELECT * FROM user WHERE email='"+mail+"'";
        ResultSet val1=userDao.Retrieve(q3);
        if(val1.next()){
            pic1=val1.getBlob("image");
...
%>
											<li>
												<div class="nearly-pepls">
													<figure>
														<a href="#" title=""><img src='data:image/jpeg;base64, <%=img1%>'></a>
													</figure>
													<div class="pepl-info">
                                                                                                            <h4><a href="#" title=""><%=val1.getString("name")%></a></h4>
														<span>Member</span>
														<!--<a href="#" title="" class="add-butn more-action" data-ripple="">unfriend</a>-->
                                                                                                                <a href="unfriend.jsp?frndemail=<%=mail%>" title="" class="add-butn" data-ripple="">unfriend</a>
													</div>
